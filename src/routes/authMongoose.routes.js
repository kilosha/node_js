...
import AuthMongooseControllers from "../controllers/authMongoose.controller.js";
 ...
 */
router.post("/login", Validator.validateLogin(), AuthMongooseControllers.login);
